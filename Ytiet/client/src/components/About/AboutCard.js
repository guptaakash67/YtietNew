...
export default function AboutCard() {
    return (
        <>
            <AnimatedElement>
                <h1 className="m-2 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-5xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-blue-700 from-blue-400">| ABOUT</span> YTIET :</h1>
            </AnimatedElement>
                ...
                <section className="text-gray-600 body-font ">
                    <div className="mx-auto flex py-6 md:px-5 md:flex-row justify-center flex-col items-center">
                        <div className="md:max-w-sm lg:max-w-md md:h-full w-full h-48 overflow-hidden flex justify-center items-center mb-4 md:mb-0">
                            ...
                            <video className="w-full md:rounded-lg" alt="hero" src='/Video/ytiet.mp4' autoPlay muted loop />
                        </div>
                        <div className="md:w-1/2  md:pl-8 flex flex-col md:items-start md:text-left items-center">
                            ...
                            <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">The Yadavrao Tasgaonkar Institute of Engineering and Technology (YTIET) is a private engineering college founded in 2005 and is a part of the Saraswati Education Society. The institute offers B.E at Undergraduate level and M.E., MMS and MCA at Postgraduate level in various specializations, <span className='font-bold'> a trust known for its deep sense of social commitment and dedicated to the promotion of education by inculcating appropriate ethics and attitude.</span></p>
                        </div>
                    </div>
                </section>
            </AnimatedElement>
            ...
            <AnimatedElement>
                <section className="text-gray-600 body-font ">
                    <div className="mx-auto flex py-10 md:px-5 md:flex-row-reverse justify-center flex-col items-center">
                        <div className="md:max-w-sm lg:max-w-md md:h-full w-full h-48 overflow-hidden flex justify-center items-center mb-4 md:mb-0">
                            <img className="w-full md:rounded-lg" alt="hero" src="/images/ytiet.jpeg" />
                        </div>
